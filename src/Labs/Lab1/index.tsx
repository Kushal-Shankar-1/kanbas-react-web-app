  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-h-tag">
        <h4>Heading Tags</h4>
        <p>
          Text documents are often broken up into several sections and subsections. HTML provides six
          levels of headings, from <code>&lt;h1&gt;</code> (the highest) to <code>&lt;h6&gt;</code>{' '}
          (the lowest). Use the headings to create a hierarchical structure for your content.
        </p>
      </div>
      ...
      <div id="wd-images">
        ...
        <img id="wd-test" src="images/test.jpg" height="200px" alt="Test Img" />
      </div>
